...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'first_name', header: 'first_name', accessorKey: 'first_name' },
    { id: 'last_name', header: 'last_name', accessorKey: 'last_name' },
    { id: 'vacation_days', header: 'vacation_days', accessorKey: 'vacation_days' },
    { id: 'payroll', header: 'payroll', accessorKey: 'payroll' },
